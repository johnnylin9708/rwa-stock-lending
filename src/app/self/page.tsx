...
import { addSelfVerifiedClaim } from "../actions/erc3643";

export default function SelfPage() {
  const { address, refreshUserInfo } = useWeb3();
  ...
  useEffect(() => {
    try {
      const app = new SelfAppBuilder({
        ...
        userDefinedData: "Hello, please verify your identity with Self App",
        disclosures: {
  ...
  const handleSuccessfulVerification = async() => {
    const result = await addSelfVerifiedClaim(address || "");
